    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="<?=ROOT?>" class="logo">
                ...
                <span class="logo-mini"><b>StF</b></span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>Save</b> Time</span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <small><i class="fa fa-clock-o"></i> 5 mins</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?=HTTP_A?>/images/adminlte/user3-128x128.jpg" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                        ...
                        <small><i class="fa fa-clock-o"></i> 2 hours</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?=HTTP_A?>/images/adminlte/user4-128x128.jpg" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                        Developers
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="<?=ROOT?>/CIndex/logout" class="btn btn-default btn-flat">Sign out</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
        ...
        <small><?=isset($pgs[0]['note']) ? $pgs[0]['note'] : ""?></small>
      </h1>
                <ol class="breadcrumb">
